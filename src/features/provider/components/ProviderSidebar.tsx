      ...
      <GlassCard className="p-6 border-purple-500/20 overflow-hidden relative">
        ...
        <div className="relative">
          <div className="flex items-center gap-4 mb-6">
            <div className="relative">
              {profile?.avatarUrl ? (
                <img src={profile.avatarUrl} alt={profile.username} className="w-20 h-20 rounded-full object-cover shadow-lg shadow-purple-500/30" />
              ) : (
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            ...
            <div className="text-center p-3 rounded-lg bg-slate-800/50">
              <p className="text-2xl font-bold text-white flex items-center justify-center gap-1">
                {profile?.rating != null ? profile.rating.toFixed(1) : '—'} <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
              </p>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            {profile && profile.rating != null && profile.rating >= 4.5 && (
            ...
            {profile?.badges.map((badge) => (
              <span key={badge} className="px-2 py-1 rounded-full text-xs font-medium bg-purple-500/10 text-purple-400 border border-purple-500/20 flex items-center gap-1">
          ...
          <div className="space-y-3 pt-4 border-t border-white/5">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-white font-medium">
                {profile?.completedJobs != null ? profile.completedJobs.toLocaleString() : '—'}
              </span>
            </div>
            <div className="flex justify-between text-sm">
